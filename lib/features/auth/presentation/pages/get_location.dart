...
class LocationAccessScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) => SetLocationCubit()..returnCurrentLocation(),
      child: BlocConsumer<SetLocationCubit, SetLocationState>(
                    ...
                    child: Stack(
                      children: [
                        ...
                        cubit.latitude != null && cubit.longitude != null
                            ...
                            : state is SaveLocationLoadingState
                                ? const Center(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                CustomElevatedButton(
                                  text:
                                      "use_current_location_button".tr(context),
